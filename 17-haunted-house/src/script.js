...
const tick = () => {
  ...
  const ghost3tAngle = -elapsedTime * 0.18;
  ghost3.position.x =
    Math.cos(ghost3tAngle) * (7 + Math.sin(elapsedTime * 0.32));
  ghost3.position.z =
    Math.sin(ghost3tAngle) * (7 + Math.sin(elapsedTime * 0.5));
