 ...
 * Particles
 */
const particlesGemometry = new THREE.BufferGeometry();
const count = 500;
...
particlesGemometry.setAttribute(
  "position",
  new THREE.BufferAttribute(position, 3)
);
particlesGemometry.setAttribute("color", new THREE.BufferAttribute(colors, 3));
...
const particles = new THREE.Points(particlesGemometry, particlesMaterials);
